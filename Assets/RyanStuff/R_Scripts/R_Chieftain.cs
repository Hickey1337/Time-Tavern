...
public class R_Chieftain : R_Enemy
{
    ...
    {
        if ( Vector3.Distance(transform.position, base.player.position) < detectPlayer )
        {
            transform.LookAt(base.player);
        }
    ...
    {
        //_rend.sharedMaterial = material[2]; //set club man to yellow
        agentSpeed = 0;
